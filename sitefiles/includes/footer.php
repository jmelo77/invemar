		...
		<!--begin::Page Scripts(used by this page) -->
		<!--<script src="assets/app/custom/general/crud/datatables/data-sources/ajax-server-side4.js" type="text/javascript"></script>-->
		<script src="ajax-server-side4.js" type="text/javascript"></script>
		<!--end::Page Scripts -->
                       
<script>
	$('a[href="#addnew"]').click(function(){
  		$("#addnew #iframe_e").html("<iframe src='editar.php' width='100%' height='520'></iframe>");
	});
</script>        
