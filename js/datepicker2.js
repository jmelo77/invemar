function VF_datepicker () {
	...
	this.datepicker = function(options){
		...
		html += '<div class="go go-left" style="top:10px;">';
		html += '<a href="#"><i class="fa fa-angle-left" style="color:#FFFFFF;font-size: 30px;"></i></a>';
		html += '</div>';
		html += '<div class="go go-right" style="top:10px;">';
		html += '<a href="#"><i class="fa fa-angle-right" style="color:#FFFFFF;font-size: 30px;"></i></a>';
		html += '</div>';
		...
		if (this.options.positions) {
			...
			this.startDP.css(this.options.positions[1], '0');
	...
	this.showEnd = function(){
		...
		if (!this.start) {
			...
			if (!this.end && this.start) {
				...
				var tmp = new Date(parseInt(tmpStart[0]), parseInt(tmpStart[1]) - 1, parseInt(tmpStart[2]) + 1);
